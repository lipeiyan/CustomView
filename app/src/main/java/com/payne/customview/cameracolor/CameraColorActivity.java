package com.payne.customview.cameracolor;
...
public class CameraColorActivity extends AppCompatActivity implements CameraColorPickerPreview.OnColorSelectedListener {
    ...
    public void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(CameraColorActivity.this,
                    Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(CameraColorActivity.this,
...
//                mCameraAsyncTask.execute();   //会和onResume重复调用
                ...
                //不同意权限那就去死吧
                CameraColorActivity.this.finish();
            }
        }
    }
    ...
    private class CameraAsyncTask extends AsyncTask<Void, Void, Camera> {
        ...
        protected Camera doInBackground(Void... params) {
            ...
            if (camera != null) {
                ...
                Cameras.setCameraDisplayOrientation(CameraColorActivity.this, camera);
        ...
        protected void onPostExecute(Camera camera) {
            ...
            if (!isCancelled()) {
                mCamera = camera;
                if (mCamera != null) {
                    mCameraPreview = new CameraColorPickerPreview(CameraColorActivity.this, mCamera);
                    mCameraPreview.setOnColorSelectedListener(CameraColorActivity.this);
